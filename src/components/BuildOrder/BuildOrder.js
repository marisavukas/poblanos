...
const BuildOrder = (props) => {
    ...
    const bagArr = [...proteinItems, ...riceItems, ...beansItems, ...topItOffItems];
    ...
    const mealString= window.localStorage.getItem('meal-selected', JSON.stringify(mealArr));
          ...
          {parsedMealString.map((item) => (
            ...
            <div className="build_your_text_contents"> 
              <div className="build_your">Build Your</div>
                ...
                <div className="build_order_meal_description">{item.description}</div>
            </div> 
            </div>
    ...
    {/* <div className='food_header_and_menu_container'> 
      ...
      <h2 className="food_header">Beans</h2>
        ...
        <div className="bean_contents"> 
          <Main foods = {beans} onAdd={onAddBeans} cartItems={beansItems}></Main>
        </div>

      <h2 className="food_header">Top it off</h2>
        <div className="topitoff_contents">
          <Main foods = {addOns} onAdd={onAddTopItOff} cartItems={topItOffItems}></Main>
        </div>
...
{/* 
      ...
      <Link to = "/checkout"><button className="order_button">Add To Bag</button></Link>
      </div>
